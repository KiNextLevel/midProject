    ...
    <div class="main">
      <div class="container">
        ...
        <div class="position-relative">
          <img src="assets/img/profile-default.png" alt="프로필 이미지" class="rounded-circle" width="100">
          <label for="profileUpload" class="position-absolute" style="top: 70px; left: 60%; cursor: pointer;">
        ...
        <a href="profile-edit.html" class="btn btn-outline-secondary btn-sm position-absolute" style="top: 15px; right: 15px;">
          ...
          <li><i class="fa fa-ruler"></i> 키</li>
          <li><i class="fa fa-weight"></i> 체형</li>
          <li><i class="fa fa-graduation-cap"></i> 학력</li>
          <li><i class="fa fa-map-marker"></i> 지역</li>
          <li><i class="fa fa-user-secret"></i> MBTI</li>
          <li><i class="fa fa-glass-martini-alt"></i> 음주</li>
          <li><i class="fa fa-smoking"></i> 흡연</li>
