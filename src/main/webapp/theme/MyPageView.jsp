				...
				<div class="sidebar col-md-3 col-sm-3">
					<ul class="list-group margin-bottom-25 sidebar-menu">
						<li class="list-group-item clearfix active"><a
							href="javascript:;"><i class="fa fa-user"></i> 내 정보</a></li>
						<li class="list-group-item clearfix"><a href="javascript:;"><i
								class="fa fa-heart"></i> 관심 목록</a></li>
						<li class="list-group-item clearfix"><a href="javascript:;"><i
								class="fa fa-calendar"></i> 이벤트 참가 내역</a></li>
						<li class="list-group-item clearfix"><a href="javascript:;"><i
								class="fa fa-coins"></i> 토큰 관리</a></li>
						<li class="list-group-item clearfix"><a href="javascript:;"><i
								class="fa fa-cog"></i> 계정 설정</a></li>
					</ul>
				</div>
						...
						<div class="profile-container">
							<div class="profile-header">
								<div class="profile-left">
									<div class="profile-image-container">
										<label for="profileUpload"> <img id="profileImage"
											src="assets/img/profile-default.png" alt="프로필 이미지" />
											<div class="image-overlay">
												<i class="fa fa-camera"></i> <span>사진 변경</span>
											</div>
										</label> <input type="file" id="profileUpload" accept="image/*" />
									</div>
								...
								<div class="profile-actions">
									<a href="/theme/MyPageEdit.jsp" class="btn btn-primary"> <i
										class="fa fa-edit"></i> 정보 수정
									</a>
								</div>
							</div>
						</div>
	...
	color: #e94d1c;
						...
						<div class="info-card">
							...
							<div class="info-list">
								...
								<div class="info-item">
									...
									<div class="info-value">${userDTO.userHeight != null ? userDTO.userHeight : '0'}
										cm</div>
								</div>
							</div>
						</div>
						...
						<div class="info-card">
							...
							<div class="info-list">
								...
								<div class="info-item">
									...
									<div class="info-value">${userDTO.userDrink == 0 ? '전혀 안함' : userDTO.userDrink == 1 ? '가끔' : userDTO.userDrink == 2 ? '자주' : '음주 정보를 입력해주세요.'}
									</div>
								</div>
								<div class="info-item">
									<div class="info-icon">
						...
						<div class="info-card">
							...
							<div class="preference-tags">
								<span class="preference-tag"><i class="fas fa-ruler"></i>
									${PreferenceDTO.preferenceHeight != null ? PreferenceDTO.preferenceHeight : '키 선호도 미설정'}</span>
								<span class="preference-tag"><i class="fas fa-weight"></i>
									${PreferenceDTO.preferenceBody != null ? PreferenceDTO.preferenceBody : '체형 선호도 미설정'}</span>
								<span class="preference-tag"><i
									class="fas fa-birthday-cake"></i> ${PreferenceDTO.preferenceAge != null ? PreferenceDTO.preferenceAge : '나이 선호도 미설정'}</span>
							</div>
						</div>
						...
						<div class="info-card">
							<h3>참가 중인 이벤트</h3>
							<%--  <p><strong>현재 보유 토큰:</strong> <span style="color: #e94d1c; font-size: 18px;">${userDTO.userToken} 개</span></p> --%>
							...
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach var="event" items="${BoardDTO.boardTitle}">
										<tr>
						...
						<div class="info-card">
							<h3>토큰 잔액 및 구매 내역</h3>
							<p>
								<strong>현재 보유 토큰:</strong> <span
									style="color: #e94d1c; font-size: 18px;">${userDTO.userToken}
									개</span>
							</p>
						...
						<div class="info-card">
							...
							<a href="AccounDelete.jsp" class="btn btn-danger"> <i
								class="fa fa-user-times"></i> 회원 탈퇴하기
							</a>
						</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 pre-footer-col">
					...
					<address class="margin-bottom-40">
						서울 강남구 테헤란로26길 12<br /> (우) 06236 (지번) 역삼동 736-56<br /> Email: <a
							href="mailto:0414minyoung@naver.com">0414minyoung@naver.com</a>
					</address>
				</div>
			</div>
		</div>
