...
<body class="ecommerce">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="shop-currencies">
                            <a href="javascript:void(0);">광고 제거</a>
                        </li>
                        <!-- END CURRENCIES -->
                        <!-- BEGIN LANGS -->
                        <li class="langs-block">
                            <a href="javascript:void(0);" class="current"> 토큰 구매 </a>
                            <div class="langs-block-others-wrapper"><div class="langs-block-others">
                              <a href="javascript:void(0);">9개</a>
                              <a href="javascript:void(0);">59개</a>
                              <a href="javascript:void(0);">99개</a>
                            </div></div>
                        </li>
                        <!-- END LANGS -->
                    </ul>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><a href="shop-account.html">마이페이지</a></li>
                        <li><a href="shop-checkout.html">메시지</a></li>
    ...
    <div class="header">
      <div class="container">
        ...
        <!-- BEGIN CART  이게 알람이 되어야하지 않을까?-->
        <div class="top-cart-block">
          <div class="top-cart-info">
            <a href="javascript:void(0);" class="top-cart-info-count">새 알림이 있습니다</a>
          </div>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-5">
            <div class="sidebar-filter margin-bottom-25">
              ...
              <div id="slider-range" class="age"></div>
              <h3>거주지역</h3>
              <div class="checkbox-list">
